      ...
      <p className="mt-3 text-gray-400">
        ...
        <div className="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-3">
          <div className="grid grid-cols-1 gap-12 sm:grid-cols-2 lg:grid-cols-1">
            <div className="container px-6 py-12 mx-auto text-center">
              <span className="inline-block p-3 text-blue-200 rounded-full bg-gray-600">
                <svg
              ...
              <p className="mt-2 text-sm text-blue-200">hello@merakiui.com</p>
            </div>

            <div className="container px-6 py-12 mx-auto text-center">
              <span className="inline-block p-3 text-blue-200 rounded-full bg-blue-100/80 bg-gray-600">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
            ...
            <div className="container px-6 py-12 mx-auto text-center">
              <span className="inline-block p-3 text-blue-200 rounded-full bg-gray-600/80 bg-gray-600">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
              ...
              <p className="mt-2 text-sm text-blue-200">+1 (555) 000-0000</p>
            </div>
          </div>
